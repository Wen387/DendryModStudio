(function registerProjectMapI18nZhHantHome(global) {
  ...
  const CATALOG = {
    'zh-Hant': {
      ...
      'home.whatsnew.v0985.home.title': '全新的首頁 Home Hub',
      'home.whatsnew.v0985.home.body': '歡迎彈窗長成了常駐的首頁：總覽、發布、公告、模板與新功能聚在一頁，最近的專案一鍵重開，每個版本還有一次開幕式。隨時點左上角字標就能回來。',
      'home.whatsnew.v0985.home.alt': 'Home Hub 總覽頁，呈現快速操作、最近的專案，以及新功能區段。',
      'home.whatsnew.v0985.tour.title': '導覽精靈帶你上手',
      'home.whatsnew.v0985.tour.body': '聚光燈式導覽搭配導覽精靈，重要介面各有一次性的情境提示，還有「動手試試」任務陪你完成第一次修改提案。',
      'home.whatsnew.v0985.tour.alt': '導覽精靈的歡迎對話框，提供一段選用的 Studio 聚光燈導覽。',
      'home.whatsnew.v0985.publish.title': '直接發布到 GitHub',
      'home.whatsnew.v0985.publish.body': '首次發布、更新推送、同步拉取都在 Studio 內完成；管理儀表板能看提交歷史、調整可見性與描述，發布中斷也能安全重試。',
      'home.whatsnew.v0985.playtest.title': '物件編輯器內嵌試玩',
      'home.whatsnew.v0985.playtest.body': '不用另跑建置流程，直接用真正的 Dendry 引擎遊玩你的事件——場景美術與音樂如實呈現，可從任何上游場景起跑，也能換個種子重抽隨機結果。',
      'home.whatsnew.v0985.playtest.alt': '物件編輯器中開啟一個事件，內嵌試玩控制列正以真正的 Dendry 引擎執行。',
      'home.whatsnew.v0985.editor.title': '條件與創作力大升級',
      'home.whatsnew.v0985.editor.body': '巢狀行內條件變成可導覽的分層樹，搭配即時 what-if 模擬器，演算指定狀態下哪些分支會顯現。超上限 magic 區塊、qdisplay 插入、素材替換、長事件搜尋與卡片「建立類似」等較小的創作缺口也一併補上。',
      'home.whatsnew.v0985.darkmode.title': '深色模式登場',
      'home.whatsnew.v0985.darkmode.body': '淺色、深色、自動三段切換，換上暖炭色調的工作環境；你的內容預覽維持紙色，所見即所得不受影響。',
      'home.whatsnew.v0985.darkmode.alt': '深色模式下的 Studio——Explore 總覽與專案統計呈現於暖炭色背景。',
      'home.whatsnew.v0985.systemui.title': '系統 UI 創作更直覺',
      'home.whatsnew.v0985.systemui.body': '建立入口改為三個直覺分類，右側欄成為可選取、可編輯的真實區域，修改會精準套用到模板，不再誤傷其他欄位。',
      'home.whatsnew.v0985.polish.title': '更快、更安靜的 Studio',
      'home.whatsnew.v0985.polish.body': '大型事件的開啟時間從約 89 秒縮短到 10 秒以內；介面全面打底——補齊空態與錯誤重試、收斂重複訊號、頂欄常駐返回鍵。',
