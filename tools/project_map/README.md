...
- v0.97.5 keeps the faster Windows installer layout from the previous preview and
...
See `tools/project_map/desktop/PACKAGING_NOTES.md` for the v0.97.5 packaging
boundary and `tools/project_map/RELEASE_NOTES_v0.97.5.md` for the tester-facing
