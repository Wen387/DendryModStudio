...
const DEFAULT_SCENARIOS = [
  ...
  ['07-system-ui-live-edit', 'system-ui-live-edit'],
  ['08-design-existing-event-canvas', 'design-existing-event-canvas'],
  ['09-explore-existing-card-canvas', 'explore-existing-card-canvas'],
  ['10-template-news', 'template-news'],
  ['11-template-card', 'template-card'],
  ['12-template-surface', 'template-surface'],
  ['13-template-entry', 'template-entry'],
  ['14-template-play-surface', 'template-play-surface'],
  ['15-template-workspace-layout', 'template-workspace-layout'],
  ['16-template-sidebar-status', 'template-sidebar-status'],
  ['17-template-project', 'template-project'],
  ['18-template-variables', 'template-variables'],
  ['19-reload-event', 'reload-event'],
  ['20-reload-card', 'reload-card'],
  ['21-reload-surface', 'reload-surface'],
  ['22-reload-workspace-layout', 'reload-workspace-layout'],
  ['23-review-event', 'review-event'],
  ['24-review-existing', 'review-existing'],
  ['25-review-surface', 'review-surface'],
  ['26-review-workspace-layout', 'review-workspace-layout'],
  ['27-legacy-fallback', 'legacy-fallback']
];
