(function initProjectMapInstallAssistant(global) {
  ...
  function renderEmptyInstallPanel() {
    return [
      ...
      '</div>',
      '</div>',
      '<div class="install-empty-group" data-install-empty-group="bring-in">',
      '<div class="install-empty-group-label">' + escapeHtml(t('install.empty.group.bringIn', 'Bring changes in')) + '</div>',
      ...
      '</div>',
      '</div>',
      '<div class="install-empty-group" data-install-empty-group="more">',
      '<div class="install-empty-group-label">' + escapeHtml(t('install.empty.group.more', 'Other options')) + '</div>',
      '<div class="install-empty-options">',
      global.dendryDesktop ? renderEmptyOption('play', t('install.empty.runtimePreview.title', 'Preview current project'), t('install.empty.runtimePreview.body', 'Run the currently loaded local repo in a temporary sandbox without applying any Studio changes.'), 'runtime-preview', t('install.runtimePreview', 'Runtime Preview'), true) : '',
