...
assert(objectAuthoringCanvasUi.includes('data-object-canvas-stage-node'), 'Object Authoring Canvas should render clickable Canvas nodes');
...
assert(html.includes('data-create-template="play_surface"'), 'Create template switch should include Playable Surface');
...
assert(css.includes('.object-canvas-layout'), 'CSS should style the Object Authoring Canvas three-area layout');
