...
目前預覽版本為 `v0.9.65`。發布版本未經簽署，因此 Windows 可能會顯示 SmartScreen 警告。桌面發布包含專案索引器所使用的 Python 執行環境。
...
1. **Studio 版本** — 顯示於應用程式的「關於」或標題列（例如 `v0.9.65`）。
...
其他工程說明位於 [tools/project_map/README.md](tools/project_map/README.md)。發布準備說明位於 [docs/releases/v0.9.65-dev-preview.md](docs/releases/v0.9.65-dev-preview.md)，測試人員版本說明位於 [tools/project_map/RELEASE_NOTES_v0.9.65.md](tools/project_map/RELEASE_NOTES_v0.9.65.md)。
