...
v0.92.1 also adds an **Announcement Preview MVP**: the desktop app can poll a
...
The desktop package version is now `0.92.1` to match the current dev preview
...
See `tools/project_map/desktop/PACKAGING_NOTES.md` for the v0.92.1 packaging
boundary and `tools/project_map/RELEASE_NOTES_v0.92.1.md` for the tester-facing
