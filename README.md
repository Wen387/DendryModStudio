...
The current preview version is `v0.98.0`. Release builds are unsigned, so Windows may show a SmartScreen warning. Desktop release artifacts include the Python runtime used by the project indexer.
...
1. **Studio version** — shown in the app's About or title bar (e.g. `v0.98.0`).
...
Additional engineering notes live in [tools/project_map/README.md](tools/project_map/README.md). Release preparation notes live in [docs/releases/v0.98-dev-preview.md](docs/releases/v0.98-dev-preview.md), and tester-facing preview notes live in [tools/project_map/RELEASE_NOTES_v0.98.md](tools/project_map/RELEASE_NOTES_v0.98.md).
