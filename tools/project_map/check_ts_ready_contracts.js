...
assert(authoringDependencyLoader.includes('install_operation_contracts.js') && authoringDependencyLoader.includes('existing_scene_line_coalescer.js') && authoringDependencyLoader.includes('route_state_model.js') && authoringDependencyLoader.includes('route_script_intelligence_model.js') && authoringDependencyLoader.includes('install_review_state_model.js') && authoringDependencyLoader.includes('install_result_report_model.js'), 'authoring dependency loader should list typed island dependencies');
...
[routeState, routeScript, semanticLogic, eventWorkbench, dynamicWorkbench, installContracts, existingSceneLineCoalescer, authoringDependencyLoader, installReviewState, installResultReport].forEach((content) => {
