...
const DEFAULT_SCENARIOS = [
  ...
  ['07-design-existing-event-canvas', 'design-existing-event-canvas'],
  ['08-explore-existing-card-canvas', 'explore-existing-card-canvas'],
  ['09-template-news', 'template-news'],
  ['10-template-card', 'template-card'],
  ['11-template-surface', 'template-surface'],
  ['12-template-entry', 'template-entry'],
  ['13-template-play-surface', 'template-play-surface'],
  ['14-template-workspace-layout', 'template-workspace-layout'],
  ['15-template-sidebar-status', 'template-sidebar-status'],
  ['16-template-project', 'template-project'],
  ['17-template-variables', 'template-variables'],
  ['18-reload-event', 'reload-event'],
  ['19-reload-card', 'reload-card'],
  ['20-reload-surface', 'reload-surface'],
  ['21-reload-workspace-layout', 'reload-workspace-layout'],
  ['22-review-event', 'review-event'],
  ['23-review-existing', 'review-existing'],
  ['24-review-surface', 'review-surface'],
  ['25-review-workspace-layout', 'review-workspace-layout'],
  ['26-legacy-fallback', 'legacy-fallback']
];
