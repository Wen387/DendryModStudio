...
function bridgeScript(options) {
  ...
  return [
    ...
    'window.DendryModStudioPreview={getStateSummary:getStateSummary,getRuntimeSnapshot:getRuntimeSnapshot,applyVariables:applyVariables,jumpToScene:jumpToScene,resetToInitialState:resetToInitialState};',
